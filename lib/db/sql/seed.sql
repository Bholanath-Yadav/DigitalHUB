...
VALUES
  ('esewa',      'eSewa',         true, 'Digital HUB Nepal', '9826749317', 'Send payment to the eSewa number above. Screenshot your receipt and upload it on the order page.', 0),
  ('khalti',     'Khalti',        true, 'Digital HUB Nepal', '9826749317', 'Send payment to the Khalti number above. Screenshot your receipt and upload it on the order page.', 1),
  ('connectips', 'ConnectIPS',    true, 'Digital HUB Nepal', '1234567890', 'Transfer via ConnectIPS and upload your transaction screenshot on the order page.', 2),
  ('bank',       'Bank Transfer', true, 'Digital HUB Nepal', 'NIC Asia – 1234567890123', 'Transfer to our NIC Asia account and upload the receipt on the order page. Include your order ID in the remarks.', 3)
