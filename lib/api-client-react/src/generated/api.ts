...
export const listPaymentSettings = async ( options?: RequestInit): Promise<PaymentSetting[]> => {
...
export const getListPaymentSettingsQueryOptions = <TData = Awaited<ReturnType<typeof listPaymentSettings>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listPaymentSettings>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListPaymentSettingsQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof listPaymentSettings>>> = ({ signal }) => listPaymentSettings({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listPaymentSettings>>, TError, TData> & { queryKey: QueryKey }
}

export type ListPaymentSettingsQueryResult = NonNullable<Awaited<ReturnType<typeof listPaymentSettings>>>
...
export function useListPaymentSettings<TData = Awaited<ReturnType<typeof listPaymentSettings>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listPaymentSettings>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const updatePaymentSetting = async (method: string,
    updatePaymentSettingBody: UpdatePaymentSettingBody, options?: RequestInit): Promise<PaymentSetting> => {
...
export const getUpdatePaymentSettingMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updatePaymentSetting>>, TError,{method: string;data: BodyType<UpdatePaymentSettingBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updatePaymentSetting>>, TError,{method: string;data: BodyType<UpdatePaymentSettingBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updatePaymentSetting>>, {method: string;data: BodyType<UpdatePaymentSettingBody>}> = (props) => {
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdatePaymentSettingMutationBody = BodyType<UpdatePaymentSettingBody>
    export type UpdatePaymentSettingMutationError = ErrorType<unknown>

    /**
 * @summary Update payment method settings (admin)
 */
export const useUpdatePaymentSetting = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updatePaymentSetting>>, TError,{method: string;data: BodyType<UpdatePaymentSettingBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const uploadPaymentScreenshot = async (uploadPaymentBody: UploadPaymentBody, options?: RequestInit): Promise<Payment> => {
...
export const getUploadPaymentScreenshotMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof uploadPaymentScreenshot>>, TError,{data: BodyType<UploadPaymentBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof uploadPaymentScreenshot>>, TError,{data: BodyType<UploadPaymentBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof uploadPaymentScreenshot>>, {data: BodyType<UploadPaymentBody>}> = (props) => {
          const {data} = props ?? {};
...
export const sendChatMessage = async (sendChatMessageBody: SendChatMessageBody, options?: RequestInit): Promise<ChatMessage> => {
...
export const getSendChatMessageMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof sendChatMessage>>, TError,{data: BodyType<SendChatMessageBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof sendChatMessage>>, TError,{data: BodyType<SendChatMessageBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof sendChatMessage>>, {data: BodyType<SendChatMessageBody>}> = (props) => {
          const {data} = props ?? {};
...
export const deleteChatSession = async (sessionId: string, options?: RequestInit): Promise<MessageResponse> => {
...
export const getUpdateUserRoleMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateUserRole>>, TError,{userId: string;data: BodyType<UpdateUserRoleBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateUserRole>>, TError,{userId: string;data: BodyType<UpdateUserRoleBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateUserRole>>, {userId: string;data: BodyType<UpdateUserRoleBody>}> = (props) => {
...
export const banUser = async (userId: string,
    banUserBody: BanUserBody, options?: RequestInit): Promise<UserProfile> => {
...
export const getBanUserMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof banUser>>, TError,{userId: string;data: BodyType<BanUserBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof banUser>>, TError,{userId: string;data: BodyType<BanUserBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof banUser>>, {userId: string;data: BodyType<BanUserBody>}> = (props) => {
          const {userId,data} = props ?? {};
...
export const updateMyProfile = async (updateProfileBody: UpdateProfileBody, options?: RequestInit): Promise<UserProfile> => {
